...
## Project Structure
    ...
    ├── nameless_flower_dev_62718  # Django project configurations
...
1. Clone this repo and `cd nameless_flower_dev_62718`
...
2. Clone this repo and `cd nameless_flower_dev_62718`
